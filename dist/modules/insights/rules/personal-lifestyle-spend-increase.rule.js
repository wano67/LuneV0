...
exports.personalLifestyleSpendIncreaseRule = personalLifestyleSpendIncreaseRule;
const prisma_1 = require("@/lib/prisma");
const ids_1 = require("@/modules/shared/ids");
const assertions_1 = require("@/modules/shared/assertions");
async function personalLifestyleSpendIncreaseRule(options) {
    ...
    if (increasePct <= 20)
        return null;
    const severity = increasePct > 50 ? 'critical' : 'warning';
    return {
