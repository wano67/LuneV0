...
exports.personalSavingsPlanService = exports.PersonalSavingsPlanService = void 0;
...
class PersonalSavingsPlanService {
    ...
    async getSavingsPlan(userIdInput, options) {
        ...
        const monthsRemaining = Math.max(1, (targetDate.getUTCFullYear() - todayDateOnly.getUTCFullYear()) * 12 +
            (targetDate.getUTCMonth() - todayDateOnly.getUTCMonth()));
        const daysRemaining = Math.max(1, Math.ceil((targetDate.getTime() - todayDateOnly.getTime()) / (1000 * 60 * 60 * 24)));
        ...
        if (estimatedSavingsCapacity <= 0 && remaining > 0) {
            ...
            if (requiredMonthlySavings <= cap * 0.8)
                status = 'on_track';
            else if (requiredMonthlySavings <= cap * 1.2)
                status = 'stretch';
            else
                status = 'unrealistic';
        }
...
exports.PersonalSavingsPlanService = PersonalSavingsPlanService;
exports.personalSavingsPlanService = new PersonalSavingsPlanService(prisma_1.prisma);
