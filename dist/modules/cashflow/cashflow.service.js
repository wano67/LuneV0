...
exports.cashflowService = exports.CashflowService = exports.InvalidCashflowInputError = void 0;
const prisma_1 = require("@/lib/prisma");
const ids_1 = require("@/modules/shared/ids");
const assertions_1 = require("@/modules/shared/assertions");
class InvalidCashflowInputError extends Error {
    constructor(message = 'Invalid cashflow projection input') {
        super(message);
        this.name = 'InvalidCashflowInputError';
    }
}
exports.InvalidCashflowInputError = InvalidCashflowInputError;
...
class CashflowService {
     ...
     */
    async computePersonalCashflowProjection(userIdInput, options) {
     ...
     */
    async computeBusinessCashflowProjection(userIdInput, businessIdInput, options) {
        const userId = (0, ids_1.normalizeUserId)(userIdInput);
    ...
    computeAverages(transactions, historySince, untilDate) {
        const totalDays = Math.max(1, Math.ceil((untilDate.getTime() - historySince.getTime()) / MS_PER_DAY));
        const { inflow, outflow } = transactions.reduce((acc, t) => {
...
exports.cashflowService = new CashflowService(prisma_1.prisma);
