...
async function main() {
    console.log('🔹 Starting ownership domain smoke test (categories, contacts, income sources, suppliers, invoices, recurring series)...');
    ...
    const mainUser = await user_service_1.userService.createUserWithDefaultSettings({
        email: mainUserEmail,
        passwordHash: 'dummy-main',
        displayName: 'Main User',
    });
    const mainUserId = mainUser.user.id;
    const mainBusiness = await business_service_1.businessService.createBusinessWithDefaultSettings({
        userId: mainUserId,
    ...
    const mainPersonalAccount = await account_service_1.accountService.createPersonalAccount({
        userId: mainUserId,
        name: 'Main perso',
        type: 'current',
        currency: 'EUR',
    ...
    const mainBusinessAccount = await account_service_1.accountService.createBusinessAccount({
        userId: mainUserId,
    ...
    const mainIncomeCategory = await prisma_1.prisma.categories.create({
        data: {
            user_id: mainUserId,
    ...
    const mainExpenseCategory = await prisma_1.prisma.categories.create({
        data: {
            user_id: mainUserId,
    ...
    const foreignUser = await user_service_1.userService.createUserWithDefaultSettings({
        email: foreignUserEmail,
        passwordHash: 'dummy-foreign',
        displayName: 'Foreign User',
    });
    const foreignUserId = foreignUser.user.id;
    const foreignPersonalAccount = await account_service_1.accountService.createPersonalAccount({
    ...
    const foreignBusiness = await business_service_1.businessService.createBusinessWithDefaultSettings({
        userId: foreignUserId,
    ...
    const foreignBusinessAccount = await account_service_1.accountService.createBusinessAccount({
        userId: foreignUserId,
    ...
    const foreignCategoryForTest = await prisma_1.prisma.categories.create({
        data: {
            user_id: mainUserId,
    ...
    const mainContact = await prisma_1.prisma.contacts.create({
        data: {
            user_id: mainUserId,
    ...
    const mainIncomeSource = await prisma_1.prisma.income_sources.create({
        data: {
            user_id: mainUserId,
    ...
    const validIncomeTx = await transaction_service_1.transactionService.createPersonalTransaction({
        userId: mainUserId,
    ...
    const foreignSupplier = await prisma_1.prisma.suppliers.create({
        data: {
    ...
    const mainSupplier = await prisma_1.prisma.suppliers.create({
        data: {
    ...
    const validSupplierTx = await transaction_service_1.transactionService.createBusinessTransaction({
        userId: mainUserId,
        businessId: mainBusinessId,
    ...
    const foreignClient = await prisma_1.prisma.clients.create({
        data: {
            business_id: foreignBusinessId,
    ...
    const foreignInvoice = await prisma_1.prisma.invoices.create({
        data: {
            business_id: foreignBusinessId,
    ...
    const mainClient = await prisma_1.prisma.clients.create({
        data: {
            business_id: mainBusinessId,
    ...
    const mainInvoice = await prisma_1.prisma.invoices.create({
        data: {
            business_id: mainBusinessId,
    ...
    const validInvoiceTx = await transaction_service_1.transactionService.createBusinessTransaction({
        userId: mainUserId,
        businessId: mainBusinessId,
        accountId: mainBusinessAccount.id,
        date: new Date(),
    ...
    const mainSeries = await prisma_1.prisma.recurring_series.create({
        data: {
            user_id: mainUserId,
    ...
    const validSeriesTx = await transaction_service_1.transactionService.createPersonalTransaction({
        userId: mainUserId,
        accountId: mainPersonalAccount.id,
        date: new Date(),
        amount: 50,
    ...
    const foreignBaseTx = await transaction_service_1.transactionService.createPersonalTransaction({
        userId: foreignUserId,
        accountId: foreignPersonalAccount.id,
        date: new Date(),
        amount: 30,
    ...
    try {
        await transaction_service_1.transactionService.updateTransaction(foreignBaseTx.id, foreignUserId, {
            categoryId: mainExpenseCategory.id,
        });
    ...
    try {
        ...
        if (err?.name === 'RecurringSeriesOwnershipError') {
            console.log('✅ RecurringSeriesOwnershipError correctly thrown on updateTransaction for foreign recurring series');
        }
        else {
